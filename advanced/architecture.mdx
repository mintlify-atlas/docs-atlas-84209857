...
description: Deep dive into Shipped's architecture, design philosophy, and technical stack
---
...
<Card title="Learn More" icon="book" href="/advanced/config-system">
...
<Card title="Learn More" icon="book" href="/advanced/package-system">
...
Effect TS uses a service-oriented architecture with compile-time dependency injection:

**Defining a Service (`server/services/config/index.ts:10`):**
...
Effect TS makes all errors explicit in type signatures:

**From `server/libs/provider/index.ts:7`:**
...
Effect provides automatic cleanup with `Effect.acquireRelease`:
...
<CardGroup cols={2}>
  <Card title="Config System" icon="gear" href="/advanced/config-system">
    Deep dive into configuration loading, validation, and hot-reloading
  </Card>
  <Card title="Package System" icon="box" href="/advanced/package-system">
